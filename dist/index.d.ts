...
export { default as ChatPopup } from './components/ChatPopup.svelte';
...
export { supabase, saveChat, loadChat } from './supabase';
export type { ChatMessage, ChatSession } from './supabase';
